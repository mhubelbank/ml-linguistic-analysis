...
The final report is presented in as a markdown-documented Jupyter Notebook [here](https://github.com/mhubelbank/ml-presidential-speeches/blob/main/final%20report/final_report.ipynb). You can also view our short presentation of the project [here](https://youtu.be/xX_li6Z6fUU).
